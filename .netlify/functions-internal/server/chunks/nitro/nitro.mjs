...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-09-16T10:43:04.535Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-09-16T10:43:04.535Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d5fc31ec-3802-420e-a928-7f0492204290",
  ...
  "prismicWebhookSecret": "my-strong-secret",
  "nuxt-scripts": {
    "version": "0.11.13"
  },
  "sitemap": {
...
const _b2JfMg9akAbjmYNmQCNK4d63t_Ybsxmp7B0H4KEdbYU = defineNitroPlugin(async (nitroApp) => {
...
const _FvDsCF2VczamxglSUiuHrqNk7awtl5msiZx5SOB15vM = defineNitroPlugin(async (nitroApp) => {
...
const _PslZBSMa4oCt9OtuqM2kxQn8Zh1QmTJgjOA1q2b70 = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _b2JfMg9akAbjmYNmQCNK4d63t_Ybsxmp7B0H4KEdbYU,
_FvDsCF2VczamxglSUiuHrqNk7awtl5msiZx5SOB15vM,
_PslZBSMa4oCt9OtuqM2kxQn8Zh1QmTJgjOA1q2b70
];

const _7X0SCN = eventHandler(async (e) => {
...
const _jkITNP = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _UGcCmW = defineEventHandler(async (e) => {
...
const _REXX8u = defineEventHandler(async (e) => {
...
const _tfgF3T = defineEventHandler(async (e) => {
...
const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.png"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":""},{"name":"format-detection","content":"telephone=no"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"title":"David Wilson","htmlAttrs":{"lang":"en"}};
...
const _gYzksC = lazyEventHandler(() => {
...
const _lazy_Ox1TWd = () => import('../routes/api/prismic/webhook.post.mjs');
const _lazy_PRMdjS = () => import('../routes/api/sitemap.xml.get.mjs');
const _lazy_qFJZl6 = () => import('../routes/renderer.mjs');
const _lazy_nwFRXT = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_bT_kA_ = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/prismic/webhook', handler: _lazy_Ox1TWd, lazy: true, middleware: false, method: "post" },
  { route: '/api/sitemap.xml', handler: _lazy_PRMdjS, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_qFJZl6, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _7X0SCN, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _jkITNP, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _UGcCmW, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _REXX8u, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _tfgF3T, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_nwFRXT, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_bT_kA_, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_bT_kA_, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _gYzksC, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_qFJZl6, lazy: true, middleware: false, method: undefined }
];
...
export { isScriptProtocol as $, replaceIslandTeleports as A, useNitroApp as B, prefixStorage as C, useStorage as D, useNitroOrigin as E, emojiCache as F, useOgImageRuntimeConfig as G, fetchIsland as H, createHeadCore as I, normaliseFontInput as J, theme as K, withTrailingSlash as L, handleCacheHeaders as M, setHeaders as N, hash$1 as O, parseURL as P, setResponseHeader as Q, proxyRequest as R, sendRedirect as S, resolveContext as T, H3Error as U, parseQuery as V, headSymbol as W, defu as X, useHead as Y, withQuery as Z, withoutTrailingSlash as _, setHeader as a, getContext as a0, sanitizeStatusCode as a1, $fetch$1 as a2, baseURL as a3, createHooks as a4, executeAsync as a5, titleCase as a6, toRouteMatcher as a7, createRouter$1 as a8, camelCase as a9, withoutBase as aa, klona as ab, useSeoMeta as ac, stringifyQuery as ad, parse as ae, getRequestHeader as af, isEqual as ag, withLeadingSlash as ah, withBase as ai, setCookie as aj, getCookie as ak, deleteCookie as al, resolveUnrefHeadInput as am, decodeHtml as an, logger$1 as ao, toBase64Image as ap, htmlDecodeQuotes as aq, sendError as ar, fontCache as as, encodeParam as at, encodePath as au, getQuery$1 as av, handler as aw, getResponseStatus as b, createError$1 as c, defineEventHandler as d, appId as e, defineRenderHandler as f, getResponseStatusText as g, buildAssetsURL as h, appTeleportTag as i, appTeleportAttrs as j, getQuery as k, createSSRContext as l, appHead as m, destr as n, setSSRError as o, publicAssetsURL as p, getRouteRules as q, readBody as r, setResponseStatus as s, getRenderer as t, useRuntimeConfig as u, getEntryIds as v, renderInlineStyles as w, hasProtocol as x, relative as y, joinURL as z };
