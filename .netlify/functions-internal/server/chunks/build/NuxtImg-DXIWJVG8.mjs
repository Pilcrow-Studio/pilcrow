...
import { X as defu, ah as withLeadingSlash, x as hasProtocol, z as joinURL, P as parseURL, at as encodeParam, au as encodePath, Z as withQuery, av as getQuery, ai as withBase } from '../nitro/nitro.mjs';
import { u as useHead, g as useNuxtApp, o as useRuntimeConfig } from './server.mjs';
...
const getImage$3 = (src, { modifiers = {}, baseURL = "/" } = {}) => {
  const operations = operationsGenerator$1(modifiers);
  return {
    url: joinURL(baseURL, src + (operations ? "?" + operations : ""))
  };
};
const imgixRuntime$MUGmaE8YB_45QM49a5t3BTb27K8AbXkb3rGy8HwWMFNf0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage: getImage$3,
  operationsGenerator: operationsGenerator$1
}, Symbol.toStringTag, { value: "Module" }));
const unsplashCDN = "https://images.unsplash.com/";
const getImage$2 = (src, { modifiers = {}, baseURL = unsplashCDN } = {}) => {
  const operations = operationsGenerator$1(modifiers);
  return {
...
const getImage$1 = (src, { modifiers = {}, baseURL = prismicCDN } = {}, ctx) => {
  if (src.startsWith(unsplashCDN)) {
    return getImage$2(src, { modifiers });
  }
  const operations = operationsGenerator$1(modifiers);
  return {
    url: withQuery(withBase(src, baseURL), getQuery("?" + operations))
...
const prismicRuntime$_88977cZdVRZtdUqczM2CGSNLbGLFIBFQTt87r0CxDLQ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage: getImage$1,
  prismicCDN
}, Symbol.toStringTag, { value: "Module" }));
...
const ipxRuntime$ZicmRUmCvu49DOaeZ1JfMF9QDyn6GAEpDs6Bh8_45ZS_A = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["prismic"]: { provider: prismicRuntime$_88977cZdVRZtdUqczM2CGSNLbGLFIBFQTt87r0CxDLQ, defaults: { "endpoint": "gauken" } },
    ["ipx"]: { provider: ipxRuntime$ZicmRUmCvu49DOaeZ1JfMF9QDyn6GAEpDs6Bh8_45ZS_A, defaults: { "modifiers": { "format": "avif" } } },
    ["imgix"]: { provider: imgixRuntime$MUGmaE8YB_45QM49a5t3BTb27K8AbXkb3rGy8HwWMFNf0, defaults: { "defaultParams": { "fm": "avif", "q": 70 } } }
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+image@1.11.0_@netlify+blobs@10.0.10_db0@0.3.2_ioredis@5.7.0_magicast@0.3.5/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main, { __name: "NuxtImg" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=NuxtImg-DXIWJVG8.mjs.map
