import { defineComponent, ref, inject, h, Suspense, withAsyncContext, unref, mergeProps, withCtx, createBlock, createCommentVNode, openBlock, watch, provide, shallowReactive, Fragment, useSSRContext } from 'vue';
import { RouterView } from 'vue-router';
import { g as useNuxtApp, P as PageRouteSymbol, L as LayoutMetaSymbol, a as usePrismic, k as useLazyAsyncData, _ as __nuxt_component_2, l as _sfc_main$a, d as useRoute, e as useAsyncData, f as _sfc_main$4 } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './NuxtImg-DXIWJVG8.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: global_navigation } = ([__temp, __restore] = withAsyncContext(() => useLazyAsyncData(
      "global_navigation",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(global_navigation)?.data?.links) {
        _push(`<nav${ssrRenderAttrs(mergeProps({ class: "fixed z-[9999] flex gap-4 py-4 px-4 mix-blend-difference text-red-500 left-[50%] translate-x-[-50%] top-5" }, _attrs))}>`);
        if (unref(global_navigation).data.logo) {
          _push(`<div>`);
          _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                if (unref(global_navigation).data.logo?.url) {
                  _push2(ssrRenderComponent(_component_NuxtImg, {
                    format: "avif",
                    src: unref(global_navigation).data.logo.url,
                    height: "40",
                    width: "40",
                    class: "w-10 h-10"
                ...
                return [
                  unref(global_navigation).data.logo?.url ? (openBlock(), createBlock(_component_NuxtImg, {
                    key: 0,
                    format: "avif",
                    src: unref(global_navigation).data.logo.url,
                    height: "40",
        ...
        _push(`<!--[-->`);
        ssrRenderList(unref(global_navigation).data.links, (item, index) => {
...
const Nav = Object.assign(_sfc_main$2, { __name: "Nav" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const prismic = usePrismic();
    const { data: footer } = ([__temp, __restore] = withAsyncContext(() => useLazyAsyncData(
      "footer",
      () => prismic.client.getSingle("footer")
    )), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SliceZone = _sfc_main$4;
      if (unref(footer)?.data?.slices) {
        _push(`<div${ssrRenderAttrs(_attrs)}>`);
        _push(ssrRenderComponent(_component_SliceZone, {
          slices: unref(footer).data.slices,
...
const Footer = Object.assign(_sfc_main$1, { __name: "Footer" });
/*!
 * strings: 3.13.0
 * https://gsap.com
 *
...
var TextPlugin = {
  ...
  init: function init(target, value, tween) {
    ...
    _tempDiv || (_tempDiv = (void 0).createElement("div"));
    ...
    const { data: art_piece } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      ...
      () => {
        if (route.params.uid && route.path.startsWith("/work/")) {
          return prismic.client.getByUID("art_piece", route.params.uid);
        }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderText.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const HeaderText = Object.assign(_sfc_main, { __name: "HeaderText" });

export { Footer as F, HeaderText as H, Nav as N, __nuxt_component_0 as _ };
//# sourceMappingURL=HeaderText-DbNt-1ly.mjs.map
