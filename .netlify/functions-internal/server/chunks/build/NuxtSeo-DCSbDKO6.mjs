...
import { m as useOgImageRuntimeConfig, n as useSiteConfig } from './server.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt-og-image@5.1.9_@unhead+vue@2.0.14_vue@3.5.21_typescript@5.9.2___h3@1.15.4_magicast_7c48f0e2d07a55595b66d2168db230b3/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const NuxtSeo = Object.assign(_sfc_main, { __name: "NuxtSeo" });

export { NuxtSeo as default };
//# sourceMappingURL=NuxtSeo-DCSbDKO6.mjs.map
